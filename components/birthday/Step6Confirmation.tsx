...
export default function Step6Confirmation({
  ...
  // Confetti emojis that burst out
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-4 py-8 text-center z-10 relative max-w-lg mx-auto overflow-hidden">
      ...
      <motion.div
        ...
        className="w-full flex flex-col items-center bg-white/70 backdrop-blur-md border border-white/50 p-10 rounded-[2.5rem] shadow-2xl shadow-accent/15 z-10 relative"
      >
        <motion.div 
          className="mb-6"
          animate={{ y: [0, -10, 0] }}
        ...
        <motion.div
          ...
          className="w-full bg-gradient-to-br from-accent-light/20 to-accent-light/10 border border-accent-light/40 rounded-2xl p-6 text-left flex flex-col gap-3 font-sans text-base text-heading/85 shadow-inner"
        >
        ...
        <motion.p
          ...
          className="text-sm text-heading/50 font-sans mt-6"
        >
