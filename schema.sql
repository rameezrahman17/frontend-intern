-- Supabase PostgreSQL Schema Setup for NexLearn Student Dashboard
-- Copy and paste this script into your Supabase SQL Editor to create and populate the database.
...
-- Insert Profile Seed Data (multiple students for leaderboard)
...
-- Insert Dynamic Activity Seed Data for the last 140 days
-- Generates daily study activities with random XP counts to form a realistic heatmap grid
INSERT INTO public.activity_logs (activity_date, activity_count)
SELECT 
    (current_date - (val || ' days')::interval)::date as activity_date,
    (floor(random() * 6.5))::integer as activity_count
